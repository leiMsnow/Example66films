...
public class Utils {
    ...
    static String getSubString(String source, String startStr, String endStr) {
     ...
     * @return
     */
    private static List<File> getFilesSortByDate(String dirPath) {
     ...
     */
    static void asyncRemoveBufferFile(final String dirPath, final int maximun) {
        new Thread() {
            public void run() {
